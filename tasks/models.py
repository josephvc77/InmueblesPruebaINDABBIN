...
class Task(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='created_tasks', null=True, blank=True)
    ...
    SECTOR_INSTITUCION_CHOICES = [
        ('SECRETARIA DE EDUCACIÓN PUBLICA', 'SECRETARIA DE EDUCACIÓN PUBLICA'),
    ]
    Sector = models.CharField(max_length=100,choices=SECTOR_INSTITUCION_CHOICES, default='SECRETARIA DE EDUCACIÓN PUBLICA',  null=True, blank=True)
    
   
    NOMBRE_INSTITUCION_CHOICES = [
        ('SECRETARIA DE EDUCACIÓN PUBLICA', 'SECRETARIA DE EDUCACIÓN PUBLICA'),
    ]
    Nombre_de_la_institucion_que_administra_el_inmueble = models.CharField(max_length=100, choices=NOMBRE_INSTITUCION_CHOICES, default='SECRETARIA DE EDUCACIÓN PUBLICA', null=True, blank=True)
    ...
    Denominaciones_anteriores = models.CharField(max_length=100, blank=True)
    ...
    subir_archivo = models.FileField(upload_to=TaskFilePath(), blank=True, null=True, editable=True)
    ...
    certificado_de_seguridad = models.CharField(max_length=2, choices=CERTIFICADO_OPCIONES, default='Si', null=True, blank=True)
    ...
    pais = models.CharField(max_length=100, choices=pais_choices, default='Mexico')
    ...
    componente_espacial = models.CharField(max_length=20, choices=COMPONENTE_ESPACIAL_CHOICES, default='SIN INFORMACION', null=True, blank=True)
    ...
    tipo_vialidad = models.CharField(max_length=20, choices=TIPO_VIALIDAD_CHOICES, default='SIN INFORMACION', null=True, blank=True)
    ...
    tipo_asentamiento = models.CharField(max_length=30, choices=TIPO_ASENTAMIENTO_CHOICES, default='SIN INFORMACIÓN', null=True, blank=True)
    ...
    datum = models.CharField(max_length=20, choices=DATUM_CHOICES, null=True, blank=True)
    ...
    superficie_del_terreno_en_M2 = models.CharField(max_length=10, null=True, blank=True)
    superficie_del_terreno_HA = models.CharField(max_length=10, null=True, blank=True)
    superficie_de_desplante_en_M2 = models.CharField(max_length=10, null=True, blank=True)
    superficie_construida_en_M2 = models.CharField(max_length=10, null=True, blank=True)
    ...
    ESTADO_CONSERVACION_CHOICES = (
        ('seleccionar_estado', 'Seleccionar el Estado de Conservación'),
        ('excelente', 'Excelente'),
        ('bueno', 'Bueno'),
        ('regular', 'Regular'),
        ('malo', 'Malo'),
    ...
    # Caracteristicas
    superficie_util_m2 = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    zona_ubicacion = models.CharField(max_length=20, choices=ZONA_CHOICES, null=True, blank=True, default='Sin Información')
    calidad_construccion = models.CharField(max_length=20, choices=CALIDAD_CHOICES, null=True, blank=True, default='Sin Información')
    servicios = models.CharField(max_length=20, choices=SERVICIOS_CHOICES, null=True, blank=True, default='Sin Información')
    telefono_inmueble = models.CharField(max_length=15, null=True, blank=True)
    fecha_inicio_construccion = models.DateField(null=True, blank=True)
    siglo_construccion = models.PositiveIntegerField(null=True, blank=True)
    fecha_ultima_remodelacion = models.DateField(null=True, blank=True)
    MONUMENTO_CHOICES = (
        ('SI', 'SI'),
        ('No', 'No'),
    )
    monumento = models.CharField(max_length=2, choices=MONUMENTO_CHOICES, null=True, blank=True, default='No')

    HISTORICO_CHOICES = (
        ('SI', 'SI'),
        ('No', 'No'),
    )
    historico = models.CharField(max_length=2, choices=HISTORICO_CHOICES, null=True, blank=True, default='No')

    ARTISTICO_CHOICES = (
        ('SI', 'SI'),
        ('No', 'No'),
    )
    artistico = models.CharField(max_length=2, choices=ARTISTICO_CHOICES, null=True, blank=True, default='No')

    ARQUEOLOGICO_CHOICES = (
        ('SI', 'SI'),
        ('No', 'No'),
    )
    arqueologico = models.CharField(max_length=2, choices=ARQUEOLOGICO_CHOICES, null=True, blank=True, default='No')
    ...
    fecha_inscripcion_unesco = models.DateField(null=True, blank=True)
    observaciones_historicas = models.CharField(max_length=100, null=True, blank=True)
    ...
    estado_conservacion = models.CharField(max_length=20, choices=ESTADO_CONSERVACION_CHOICES, null=True, blank=True)
    ...
    # ---------------------------- campos Uso ----------------------------------------------------
    usuario_principal_del_inmueble = models.CharField(max_length=255, null=True, blank=True)
    usoGenerico = models.CharField(max_length=255, null=True, blank=True)
    usoEspecifico = models.CharField(max_length=255, null=True, blank=True)
    ...
    uso_de_suelo_autorizado = models.CharField(max_length=255, choices=UsoSueloChoice, default="SIN INFORMACIÓN", null=True, blank=True)
    
    
    numero_de_empleados_en_el_inmueble = models.DecimalField(max_digits=10, decimal_places=0, null=True, blank=True)
    DOCUMENTO_OCUPACION_CHOICEONES = [
        ('Si', 'Si'),
        ('No', 'No'),
    ]
    documento_que_autoriza_ocupacion = models.CharField(max_length=2, choices=DOCUMENTO_OCUPACION_CHOICEONES, default='No')
    numero_de_documentos_de_ocupacion = models.DecimalField(max_digits=10, decimal_places=0, null=True, blank=True)
    INSTITUCIONES_OCUPANTES_CHOICE = [
        ('Si', 'Si'),
        ('No', 'No'),
    ]
    instituciones_ocupantes = models.CharField(max_length=2, choices=INSTITUCIONES_OCUPANTES_CHOICE, default='No', null=True, blank=True)
    USUARIOS_TERCEROS_CHOICE = [
        ('Si', 'Si'),
        ('No', 'No'),
    ]
    usuarios_terceros = models.CharField(max_length=2, choices=USUARIOS_TERCEROS_CHOICE, default='No', null=True, blank=True)
    ...
    aprovechamiento = models.CharField(max_length=20, choices=APROVECHAMIENTO_CHOICES, default='SIN INFORMACIÓN', null=True, blank=True)
    
    inmueble_con_atencion_al_publico = models.BooleanField(default=False, null=True, blank=True)
    poblacion_beneficiada = models.CharField(max_length=200 ,null=True, blank=True)
    poblacion_servicio = models.CharField(max_length=200 ,null=True, blank=True)
    
    cuenta_con_proyecto_de_uso_inmediato_desarrollado = models.BooleanField(default=False, null=True, blank=True)
    inversion_requerida = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    ...
    gasto_anual_de_mantenimiento = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    inmueble_en_condominio = models.BooleanField(default=False, null=True, blank=True)
    superficie_total = models.CharField(max_length=200, null=True, blank=True)
    indiviso = models.CharField(max_length=200, null=True, blank=True)
    
    # -------------------------------- campos Valor ------------------------------------------------------------------
    valor_contable = models.CharField(max_length=200, null=True, blank=True)
    fecha_valor_contable = models.DateField(null=True, blank=True)
    valor_asegurable = models.CharField(max_length=200, null=True, blank=True)
    fecha_valor_asegurable = models.DateField(null=True, blank=True)
    valor_adquisicion = models.CharField(max_length=200, null=True, blank=True)
    fecha_valor_adquisicion = models.DateField(null=True, blank=True)
    valor_terreno = models.CharField(max_length=200, null=True, blank=True)
    valor_construccion = models.CharField(max_length=200, null=True, blank=True)
    valor_catastral_terreno = models.CharField(max_length=200, null=True, blank=True)
    valor_catastral_construccion = models.CharField(max_length=200, null=True, blank=True)
    valor_total_catastral = models.CharField(max_length=200, null=True, blank=True)
    fecha_valor_catastral = models.DateField(null=True, blank=True)
    ...
    def __str__(self):
        return self.rfi + ' - ' + self.NombreInmueble


class FoliosReales(models.Model):
    ...
    def __str__(self):
        if self.folios_reales_data is not None:
            return self.folios_reales_data
        else:
            return "Folio Real sin datos"
    
    
class NumeroPlano(models.Model):
    task = models.ForeignKey(Task, on_delete=models.CASCADE, related_name='numeros_planos')
    numero_plano_data = models.CharField(max_length=5, null=True, unique=True,)
    
    def __str__(self):
        return self.numero_plano_data

    
class Expedientes_CEDOC(models.Model):
    task = models.ForeignKey(Task, on_delete=models.CASCADE)
    expediente_cedoc_data = models.CharField(max_length=100, unique=True, null=True)

    def __str__(self):
        return self.expediente_cedoc_data
    
class EdificioVerde(models.Model):
    task = models.ForeignKey(Task, on_delete=models.CASCADE,  related_name='edificio_verde_set')
...
class Edificacion(models.Model):
    ...
    niveles_por_edificio = models.IntegerField(default=0, null=True, blank=True)
    superficie_construida_por_edificacion_m2 = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    ...
    cajones_de_estacionamiento_por_edificacion = models.IntegerField(null=True, blank=True)
...
class Colindancias(models.Model):
    ...
    colindancia = models.DecimalField(max_digits=10,decimal_places=2, null=True, blank=True)
    medida_en_metros = models.DecimalField(max_digits=10,decimal_places=2, null=True, blank=True)
...
class DatosAvaluos(models.Model):
    task = models.ForeignKey(Task, on_delete=models.CASCADE)
...
class TramitesDisposicion(models.Model):
    task = models.ForeignKey(Task, on_delete=models.CASCADE)
...
class Documento_ocupacion(models.Model):
    task = models.ForeignKey(Task, on_delete=models.CASCADE)
    ...
    ('ACUERDO DE DESTINO', 'ACUERDO DE DESTINO'),
    ('ADQUISIONES POSTERIORES A 2004', 'ADQUISIONES POSTERIORES A 2004'),
    ('ARRENDAMIENTO', 'ARRENDAMIENTO'),
...
class InstitucionesOcupantes(models.Model):
    task = models.ForeignKey(Task, on_delete=models.CASCADE)
    ...
    uso_institucion_ocupante = models.CharField(max_length=150, null=True, blank=True)
    superficie_disponible = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    
class DatosTerceros(models.Model):
    task = models.ForeignKey(Task, on_delete=models.CASCADE)
...
class Inmueble(models.Model):
    ...
    Nombre_de_la_institucion_que_administra_el_inmueble = models.CharField(max_length=300, choices=NOMBRE_INSTITUCION_CHOICES,  null=True, blank=True)
    
    subSeccion= models.CharField(max_length=300, null=True, blank=True)
    
    NATURALEZA_JURIDICA_CHOICES = [
        ('DEPENDENCIA', 'DEPENDENCIA'),
    ]
    Naturaleza_Juridica_de_la_Institucion = models.CharField(max_length=300, choices=NATURALEZA_JURIDICA_CHOICES, default='DEPENDENCIA',  null=True, blank=True)
    causa_alta_choices = [
        ('SIN INFORMACION', 'SIN INFORMACION'),
        ('POR ADQUISICION DEL INMUEBLE', 'POR ADQUISICION DEL INMUEBLE'),
        ('CUANDO SE HAYA OMITIDO DAR DE ALTA UN INMUEBLE FEDERAL', 'CUANDO SE HAYA OMITIDO DAR DE ALTA UN INMUEBLE FEDERAL'),
    ...
    sentido_del_Dictamen = models.CharField(max_length=300, choices=SENTIDO_DICTAMEN_OPCIONES, default='Inmueble Seguro',  null=True, blank=True)
    
    descripcion_del_sentido_del_Dictamen = models.TextField(null=True, blank=True)
    fecha_documento = models.DateField(null=True, blank=True)
    no_de_identificador_del_expediente_institucion = models.CharField(max_length=200,  null=True, blank=True)
    ...
    pais = models.CharField(max_length=100, choices=pais_choices, default='Mexico', null=True, blank=True)
    ...
    nombre_vialidad = models.CharField(max_length=200,  null=True, blank=True)
    ...
    nombre_asentamiento = models.CharField(max_length=300,  null=True, blank=True)
    codigo_postal = models.CharField(max_length=40,  null=True, blank=True)
    entre_vialidades_referencia1 = models.CharField(max_length=500,  null=True, blank=True)
    entre_vialidades_referencia2 = models.CharField(max_length=500,  null=True, blank=True)
    vialidad_posterior = models.CharField(max_length=500,  null=True, blank=True)
    descripcion_ubicacion = models.TextField(null=True, blank=True)
    ...
    datum = models.CharField(max_length=300, choices=DATUM_CHOICES, null=True, blank=True)
    utmx = models.CharField(max_length=300, blank=True, null=True)
    utmy = models.CharField(max_length=300, blank=True, null=True)
    utm_zona = models.CharField(max_length=300, blank=True, null=True)
    ...
    superficie_del_terreno_en_M2 = models.CharField(max_length=200, null=True, blank=True)
    superficie_del_terreno_HA = models.CharField(max_length=200, null=True, blank=True)
    superficie_de_desplante_en_M2 = models.CharField(max_length=200, null=True, blank=True)
    superficie_construida_en_M2 = models.CharField(max_length=200, null=True, blank=True)
       # Opciones para los campos de selección
    ZONA_CHOICES = (
        ('sin informacion', 'Sin Información'),
        ('rural', 'Rural'),
    ...
    zona_ubicacion = models.CharField(max_length=200, choices=ZONA_CHOICES, null=True, blank=True, default='Sin Información')
    calidad_construccion = models.CharField(max_length=200, choices=CALIDAD_CHOICES, null=True, blank=True, default='Sin Información')
    servicios = models.CharField(max_length=200, choices=SERVICIOS_CHOICES, null=True, blank=True, default='Sin Información')
    ...
    clave_inah = models.CharField(max_length=200, null=True, blank=True)
    folio_real_inah = models.CharField(max_length=200, null=True, blank=True)
    no_plano_inah = models.CharField(max_length=200, null=True, blank=True)
    clave_cnmh = models.CharField(max_length=200, null=True, blank=True)
    clave_dgsmpc_conaculta = models.CharField(max_length=200, null=True, blank=True)
    ...
    siglo_o_periodo = models.CharField(max_length=200, null=True, blank=True)
    correlativo = models.CharField(max_length=200, null=True, blank=True)
    conjunto = models.CharField(max_length=200, null=True, blank=True)
    clave_inbal = models.CharField(max_length=200, null=True, blank=True)
    registro_unico_inah = models.CharField(max_length=200, null=True, blank=True)
    

    estado_conservacion = models.CharField(max_length=300, choices=ESTADO_CONSERVACION_CHOICES, null=True, blank=True)
    ...
    aprovechamiento = models.CharField(max_length=200, choices=APROVECHAMIENTO_CHOICES, default='SIN INFORMACIÓN', null=True, blank=True)
    ...
    cuenta_con_proyecto_de_uso_inmediato_desarrollado = models.CharField(max_length=200, choices=cuenta_con_proyecto_de_uso_inmediato_desarrollado_choice, null=True, blank=True)
    
    
    inversion_requerida = models.CharField(max_length=200, null=True, blank=True)
    fuente_financiamiento = models.CharField(max_length=300, null=True, blank=True)
    fecha_solicitud = models.CharField(max_length=100 ,null=True, blank=True)
    
    inmueble_no_aprovechable_especificar = models.TextField(null=True, blank=True)
    
    gasto_anual_de_mantenimiento = models.CharField(max_length=200, null=True, blank=True)
