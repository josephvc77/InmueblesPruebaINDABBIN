...
class Task(models.Model):
    ...
    NombreInmueble = models.CharField(max_length=200, verbose_name='Nombre del inmueble')
    ...
    Nombre_de_la_institucion_que_administra_el_inmueble = models.CharField(max_length=100, choices=NOMBRE_INSTITUCION_CHOICES, default='SECRETARIA DE EDUCACIÓN PUBLICA')
    ...
    Naturaleza_Juridica_de_la_Institucion = models.CharField(max_length=100, choices=NATURALEZA_JURIDICA_CHOICES, default='DEPENDENCIA')
    causa_alta_choices = [
    ...
    causa_alta = models.CharField(max_length=100, choices=causa_alta_choices, default='SIN INFORMACION')
    ...
    certificado_de_seguridad = models.CharField(max_length=2, choices=CERTIFICADO_OPCIONES, default='Si')
    ...
    sentido_del_Dictamen = models.CharField(max_length=100, choices=SENTIDO_DICTAMEN_OPCIONES, default='Inmueble Seguro')
    
    descripcion_del_sentido_del_Dictamen = models.TextField(blank=True)
    fecha_documento = models.DateField(null=True, blank=True)
    no_de_identificador_del_expediente_institucion = models.CharField(max_length=100, blank=True)
    ...
    entidad_federativa = models.CharField(max_length=100, blank=False, null=False)
    municipio_alcaldia = models.CharField(max_length=100, blank=False, null=False)
    ...
    componente_espacial = models.CharField(max_length=20, choices=COMPONENTE_ESPACIAL_CHOICES, default='SIN INFORMACION')
    ...
    tipo_vialidad = models.CharField(max_length=20, choices=TIPO_VIALIDAD_CHOICES, default='SIN INFORMACION')

    nombre_vialidad = models.CharField(max_length=100, blank=True)
    ...
    tipo_asentamiento = models.CharField(max_length=30, choices=TIPO_ASENTAMIENTO_CHOICES, default='SIN INFORMACIÓN')

    nombre_asentamiento = models.CharField(max_length=100, blank=True)
    codigo_postal = models.CharField(max_length=10, blank=True)
    entre_vialidades_referencia1 = models.CharField(max_length=100, blank=True)
    entre_vialidades_referencia2 = models.CharField(max_length=100, blank=True)
    vialidad_posterior = models.CharField(max_length=100, blank=True)
    ...
    uso_de_suelo_autorizado = models.CharField(max_length=255, choices=UsoSueloChoice, default="SIN INFORMACIÓN")
    ...
    instituciones_ocupantes = models.CharField(max_length=2, choices=INSTITUCIONES_OCUPANTES_CHOICE, default='No')
    USUARIOS_TERCEROS_CHOICE = [
        ('Si', 'Si'),
        ('No', 'No'),
    ]
    usuarios_terceros = models.CharField(max_length=2, choices=USUARIOS_TERCEROS_CHOICE, default='No')
    ...
    poblacion_beneficiada = models.IntegerField(null=True, blank=True)
    poblacion_servicio = models.IntegerField(null=True, blank=True)
    ...
    indiviso = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    ...
    valor_asegurable = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    ...
    valor_terreno = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    valor_construccion = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    valor_catastral_terreno = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    valor_catastral_construccion = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    valor_total_catastral = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
