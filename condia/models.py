...
class TareasCondia(models.Model):
    ...
    titulo = models.CharField(max_length=20050, null=True, blank=True)
    descripcion = models.TextField( null=True, blank=True)
    uso_inmueble = models.CharField(max_length=50, null=True, blank=True)
    riuf = models.CharField(max_length=50, null=True, blank=True)
    ...
    uso_suelo = models.CharField(max_length=50, null=True, blank=True)
    no_contrato = models.CharField(max_length=50, null=True, blank=True)
    ...
    propietario_representante = models.CharField(max_length=50, null=True, blank=True)
    identificacion_oficial = models.CharField(max_length=50, null=True, blank=True)
    ...
    nombre_asentamiento = models.CharField(max_length=50, null=True, blank=True)
    codigo_postal = models.CharField(max_length=10, null=True, blank=True)
    entre_vialidades_referencia1 = models.CharField(max_length=50, null=True, blank=True)
    entre_vialidades_referencia2 = models.CharField(max_length=50, null=True, blank=True)
    vialidad_posterior = models.CharField(max_length=50, null=True, blank=True)
